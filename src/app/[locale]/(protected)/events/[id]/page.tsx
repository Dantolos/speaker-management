...
import EventDetailTabs from "@/component/Pages/Events/EventDetailTabs";
...
export default async function EventDetailPage({
  ...
  // Panels als ReactNode für die Tabs
  const generalPanel = (
  ...
  const programPanel = <ProgramCalendar program={program} eventId={id} />;

  const metricsPanel = <EventMetricsCharts metrics={metrics} />;

  return (
    <div className="p-8 max-w-[1200px] mx-auto">
      {/* Header (außerhalb der Tabs) */}
      <div className="mb-6">
